...
class DashboardOrderPendingController extends Controller
{
    /**
    ...
    {
        return view('dashboard/transaction/order_pending/index');
    }
    ...
    public function Post(Request $request)
    {
        ...
        if(!empty($posts))
        {
            ...
            {
                $edit =  $post->id;
                $url_show="/dashboard/order_pending/create?id=".$edit;
                $url_edit="/dashboard/order_pending/create?id=".$edit;
                $url_delete="/dashboard/order_pending/delete?id=".$edit;
    ...
    public function create(Request $request)
    {
        ...
        return view('dashboard/transaction/order_pending/create', $data);
        }
    }
    ...
    public function delete(Request $request)
    {
        ...
        return Redirect::to('/dashboard/order_pending');
    }
}